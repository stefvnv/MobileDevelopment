...
public class PannaCottaActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btnSave.setOnClickListener(view -> {
            ...
            preferences = getSharedPreferences("notes_panna", MODE_PRIVATE);
        ...
        btnClear.setOnClickListener(view -> {
            if (textViewSaved.getText().toString().equals("")) {
                Toast.makeText(PannaCottaActivity.this, "There are no notes to be cleared.", Toast.LENGTH_SHORT).show();
            } else {
        ...
        btnCapture.setOnClickListener(view -> {
            ...
            try {
                ...
                Toast.makeText(PannaCottaActivity.this, "Capturing image failed.", Toast.LENGTH_SHORT).show();
            }
        });
    }
    ...
    public void getShared() {
        SharedPreferences preferences = getSharedPreferences("notes_panna", MODE_PRIVATE);
        txt = preferences.getString("text", "");
        textViewSaved.setText(txt);
    }
    ...
    public void getSharedTicked(MenuItem item) {
        preferences = getSharedPreferences("tick_panna", MODE_PRIVATE);
        SharedPreferences.Editor editor = preferences.edit();
    ...
    public void getSharedTicked(MenuItem item, boolean comingFromMain) {
        SharedPreferences contextTick = getSharedPreferences("tick_panna", MODE_PRIVATE);
